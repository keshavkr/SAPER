...
public interface UMConstants extends SAPConstants {
	...
	String[] mandatoryUserReconSchedulerAttrs = {"IT Resource",
			...
			"Child Attribute Mapping Lookup", "Batch Size",
			"Last Execution Timestamp", "SAP System Time Zone"};
	...
	String[] mandatoryUMITRes = { "Client logon", "Admin logon", "Admin password",
			"Language", "SNC mode","Master system name" };
	...
	String BAPI_USER_SYSTEM_ASSIGN = "BAPI_USER_SYSTEM_ASSIGN";
	String IS_SYSTEM_NEED_TO_REMOVE = "Is System Need To Remove";
	...
	public String UnlockWhileEnable= "Unlock While Enable";
	...
	//Start: Bug 18342752- WHEN AN USER FROM CUA IS DISABLED AND ENABLED AGAIN, THE USER IS STILL DISABLED
	String  DISABLE_LOCK_STATUS="Disable Lock Status";
	//End: Bug 18342752- WHEN AN USER FROM CUA IS DISABLED AND ENABLED AGAIN, THE USER IS STILL DISABLED 
	/*
	 * Start Code Modified for Role 10373020
	 */
	
	String RECONCILE_FUTURE_DATED_ROLES = "Reconcile future dated roles";
	String RECONCILE_PAST_DATED_ROLES = "Reconcile past dated roles";
	...
	String ZXLUSERNAME = "ZXLUSERNAME";
	String ZXLOLD_PASSWORD = "ZXLOLD_PASSWORD";
	String ZXLNEW_PASSWORD = "ZXLNEW_PASSWORD";
	String CHANGE_FLAG = "CHANGE_FLAG";
	...
	String PROVIDE_PASSWORD_DIFFERENT_FROM_PREVIOUS = "PROVIDE_PASSWORD_DIFFERENT_FROM_PREVIOUS";
	...
	String ZXLCBAPI_ZXLCUSR_PW_CHANGE = "ZXLCBAPI_ZXLCUSR_PW_CHANGE";
	String ZXLCBAPI_ZXLCUSR_PASSWORDCHNGE = "ZXLCBAPI_ZXLCUSR_PASSWORDCHNGE";
	...
	// Start :: Added for the bug 12586222
	String IT_RESOURCE_KEY="IT Resource Key";
	// End :: Added for the bug 12586222
	...
	// Start :: Added for the bug 10408848
	String UDFIELD_FOR_VALIDTHROUGH = "UDField For ValidThrough";
	// End :: Added for the bug 10408848
	
	// IT Resource Attribute
	String CLIENT_LOGON = "Client logon";
	String ADMIN_LOGON = "Admin logon";
	String ADMIN_PASSWORD = "Admin password";
	String LANGUAGE = "Language";
	String SNC_MODE = "SNC mode";
	String MASTER_SYSTEM_NAME = "Master system name";
	String SNC_PARTNER_NAME = "SNC partner name";
	String SNC_MY_NAME = "SNC my name";
	String SNC_LIB = "SNC lib";
	String SNC_QOP = "SNC qop";
	String IS_PASSWORD_PROPAGATE_TO_CHILD_SYSTEM = "Is Password Propagate To Child System";
	//Start:: Added for Password propagate Delay - BUG 17159673
	String PASSWORD_PROPAGATE_DELAY="CUA Password Propagate Delay Time";
